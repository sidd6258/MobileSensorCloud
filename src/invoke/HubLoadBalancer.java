...
public class HubLoadBalancer {
	...
	{
		int new_hub_id;
		String q = "SELECT  hub_id from sensorcloud.hub_master where no_of_server<3 and cpu_utilization<'75'";
		...
		if(check_hub_id==0)
		{
			...
			String qu="SELECT sensor_id, AVG(cpu_data) as avgutil FROM sensorcloud.utilization group by sensor_id";
